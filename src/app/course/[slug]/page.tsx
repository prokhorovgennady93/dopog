      ...
      <div className="max-w-5xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row gap-12 items-start">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center justify-between gap-3 bg-zinc-50 dark:bg-zinc-900 p-4 rounded-xl border border-zinc-100 dark:border-zinc-800 mb-8 lg:pr-8">
              <div className="flex items-center gap-3">
                <CloudDownload className="w-5 h-5 text-zinc-400 shrink-0" />
                <span className="text-sm font-bold">Оффлайн доступ</span>
              </div>
            ...
            <div className="space-y-4 mb-12">
              <div className="flex items-center justify-between pb-2 border-b border-zinc-100 dark:border-zinc-800">
                <h2 className="text-xl font-black flex items-center gap-2">
                  <BookOpen className="w-5 h-5 text-yellow-500 shrink-0" />
                  Темы обучения
                </h2>
                <div className="flex items-center pr-4 sm:pr-8 shrink-0">
              ...
              <div className="grid grid-cols-1 gap-3">
                {(course as any).themes.map((topic: any) => (
                  ...
                  >
                    ...
                    >
                      <CheckCircle className="w-5 h-5 text-zinc-300 group-hover:text-yellow-500 shrink-0" />
                      <span className="text-sm font-semibold">{topic.title}</span>
                    </Link>

                    <div className="flex items-center">
                      <span className="text-xs sm:text-sm font-black text-zinc-600 dark:text-zinc-300 w-12 sm:w-16 text-center">
