...
export default async function Home() {
  ...
  return (
    <div className="flex flex-col flex-1">
      ...
      {/* Courses Catalog */}
      <section id="courses" className="mt-[450px] sm:mt-0 scroll-mt-20 py-16 sm:py-24 bg-zinc-50/50 dark:bg-zinc-950/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-end mb-12 gap-4 pr-1 sm:pr-0">
            <div className="w-full text-right sm:text-left mt-8 sm:mt-0">
