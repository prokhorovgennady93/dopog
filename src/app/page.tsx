...
export default async function Home() {
  ...
  return (
    <div className="flex flex-col flex-1">
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-white dark:bg-zinc-950 pt-24 pb-8 sm:pt-12 sm:pb-24 border-b-0 sm:border-b border-zinc-100 dark:border-zinc-900">
