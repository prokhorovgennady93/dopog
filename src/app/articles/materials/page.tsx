...
const materials = [
  {
    title: "Официальный текст ДОПОГ (Том 1)",
    description: "Действующая редакция на русском языке от Европейской экономической комиссии ООН (ЕЭК ООН). Соглашение, определения, перечень опасных грузов.",
    link: "https://unece.org/transport/dangerous-goods",
    type: "PDF (UNECE)",
    icon: <Globe className="w-5 h-5 text-blue-500" />
  },
  {
    title: "Официальный текст ДОПОГ (Том 2)",
    description: "Требования к таре, цистернам, маркировке и персоналу. Обязателен для глубокого изучения перевозчиками.",
    link: "https://unece.org/transport/dangerous-goods",
    type: "PDF (UNECE)",
    icon: <Globe className="w-5 h-5 text-blue-500" />
  },
  {
    title: "Методическое пособие водителя ОГ",
    description: "Понятные иллюстрации, таблицы совместимости и чек-листы для подготовки транспортного средства к рейсу.",
    link: "https://rosavtotransport.ru",
    type: "Учебник",
