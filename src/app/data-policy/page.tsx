      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-zinc dark:prose-invert max-w-none space-y-12 font-medium">
          <section className="bg-zinc-50 dark:bg-zinc-900 p-8 rounded-3xl border border-zinc-100 dark:border-zinc-800 italic text-sm">
             Настоящая Политика разработана в соответствии с требованиями Федерального закона от 27.07.2006 № 152-ФЗ «О персональных данных» и определяет порядок обработки персональных данных и меры по обеспечению их безопасности в ООО «Учебный центр Технологии Знаний».
          </section>
          ...
          <section>
             ...
             <ul className="space-y-4">
                ...
                <li><b>Оператор</b> — ООО «Учебный центр Технологии Знаний» (ИНН 6166132362).</li>
             </ul>
          </section>
          ...
          <section>
             ...
             <p>6.1. Пользователь может получить любые разъяснения по интересующим вопросам, касающимся обработки его персональных данных, обратившись к Оператору с помощью электронной почты <b>znania.group@gmail.com</b>.</p>
          ...
          <section className="bg-zinc-900 p-8 sm:p-12 rounded-[40px] text-zinc-500 text-xs">
             <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-[10px] uppercase font-black tracking-widest leading-relaxed">
                <div>
                   <p className="text-zinc-200">ООО «Учебный центр Технологии Знаний»</p>
                   <p>ИНН 6166132362</p>
